...
export const generateRecommendations = async (categories) => {
  ...
  try {
    ...
    {
      "id": "unique-id",
      "icon": "material-icon-name (e.g., flash-on, money-off, receipt, swap-horiz, fastfood, phone)",
      "title": "Short actionable title mentioning the specific merchant or habit",
      "subtitle": "Brief context using their actual data (e.g., 'Spent P450 at Spar this month')",
      "issue": "Educational explanation of why this behavior is draining their finances and how it impacts them.",
      "estFees": "Cost context string (e.g., 'P 150.00 total spent')",
      "betterOption": "A clear, actionable step-by-step plan on how the user should change this habit and plan their finances better.",
      "saving": "String describing the exact benefit (e.g., 'P 45.00/month')",
      "savingRaw": 45, // estimated numeric saving. MUST be a plain number, no expressions.
